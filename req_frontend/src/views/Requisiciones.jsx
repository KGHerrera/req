...
const Requisiciones = () => {
    ...
    useEffect(() => {
        if (user) {
            ...
            setFolioData({
                folio: `${user.clave_departamento}${year}-03`,
    ...
    const handleSubmit = async (e) => {
        ...
        if (folioData.total_estimado === '') {
            errors.total_estimado = 'Por favor, ingresa un valor para el total estimado';

        }

        // si no es numero
        if (isNaN(folioData.total_estimado)) {
            errors.total_estimado = 'Por favor, ingresa un valor numerico para el total estimado'
        }

        // si no hay requisiciones en folioData
        if (requisiciones.length === 0) {
            errors.requisiciones = 'Por favor, agrega al menos una requisición'
        }
        ...
        axiosClient.post('/folio-requisicion', data)
            .then(() => {
                console.log('Folio y Requisiciones guardados con éxito');
            })
            .catch((err) => {
                            ...
                            <div className="card-body">
                                <form>
                                    <div className="row">
                                        ...
                                        <div className="col-md-4 mb-3">
                                            <label htmlFor="fechaEntrega" className="form-label">Fecha de Entrega estimada</label>
                                    ...
                                    <div className="row">
                                        <div className="col-md-4 mb-3">
                                            ...
                                            />
                                            {errors.total_estimado && <p className="text-danger">{errors.total_estimado}</p>}
                                        </div>
                                        <div className="col-md-4 mb-3">
                                        ...
                                        <div className="col-md-4 mb-3">
                                            <label htmlFor="claveDepartamento" className="form-label">Clave de Departamento</label>
                            ...
                            <div className="card-body">
                                <div className="row">
                                    <div className="col-md-4 mb-3">
                                        ...
                                        {errors.partida_presupuestal && <p className="text-danger">{errors.partida_presupuestal}</p>}
                                    </div>
                                    <div className="col-md-4 mb-3">
                                        ...
                                        {errors.cantidad && <p className="text-danger">{errors.cantidad}</p>}
                                    </div>
                                    <div className="col-md-4 mb-3">
                                        ...
                                        {errors.unidad && <p className="text-danger">{errors.unidad}</p>}
                                    </div>
                                </div>
                                <div className="row">
                                    <div className="col-md-4 mb-3">
                                        ...
                                        {errors.descripcion_bienes_servicios && <p className="text-danger">{errors.descripcion_bienes_servicios}</p>}
                                    </div>
                                    <div className="col-md-4 mb-3">
                                        <label htmlFor="costoEstimado" className="form-label">Costo Estimado</label>
                                        ...
                                        {errors.costo_estimado && <p className="text-danger">{errors.costo_estimado}</p>}
                                    </div>

                                </div>
                                <button type="button" className="btn btn-primary btn-block" onClick={addRequisicion}>Añadir Requisición</button>
                                ...
                                {errors.requisiciones && <p className="text-danger">{errors.requisiciones}</p>}

                                <button type="submit" className="btn btn-primary mt-3" onClick={handleSubmit}>Enviar folio y requisiciones</button>
                            </div>
                        </div>
                    </div>
                </div>
